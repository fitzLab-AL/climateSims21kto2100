...
contains
  ...
  subroutine get_final(lon11,lon22,lat1,lat2,decade,vars)
    ...
    call handle_err(nf90_open('/Users/djlorenz/Research/jack/final/ECBilt/'// &
    ...
    ! decade
    if(decade<-2100 .or. decade>-1) then
    ...
    do ivar=1,nvar
       if(vars0(ivar)=='tmax' .or. vars0(ivar)=='tmin') then
          call handle_err(nf90_open('/Users/djlorenz/Research/jack/final/ECBilt/'// &
               'temp.nc',nf90_nowrite,ncid))
       elseif(vars0(ivar)=='pet' .or. vars0(ivar)=='aet') then
          call handle_err(nf90_open('/Users/djlorenz/Research/jack/final/ECBilt/'// &
               'ET.nc',nf90_nowrite,ncid))
       elseif(vars0(ivar)=='gdd0' .or. vars0(ivar)=='gdd5') then
          call handle_err(nf90_open('/Users/djlorenz/Research/jack/final/ECBilt/'// &
               'gdd.nc',nf90_nowrite,ncid))
       else
          call handle_err(nf90_open('/Users/djlorenz/Research/jack/final/ECBilt/'// &
