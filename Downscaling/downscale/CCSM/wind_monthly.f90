!seasonal wind => monthly wind
!gfortran -O3 -o wind_monthly wind_monthly.f90 read_CCSM.o hybrj.o seasonal_monthly.o -I/Users/djlorenz/Research/netcdf/include -I/Users/djlorenz/lib -L/Users/djlorenz/Research/netcdf/lib -L/Users/djlorenz/lib -lnetcdff -lnetcdf  -llapack -lblas -lmylib
program wind
  ...
  open(1,file='wind.dat',access='stream',form='unformatted')
  read(1) xsea
  close(1)
...
!              call sea1month(xsea(ilon,ilat,idecade,:),xmon(ilon,ilat,idecade,:))
  ...
  call ctlwrite('wind_monthly.ctl','wind',lons=lonsc,lats=latsc, &
