...
!gfortran -O3 -o lwn lwn.f90 read_CCSM.o -I/Users/djlorenz/Research/netcdf/include -I/Users/djlorenz/lib -L/Users/djlorenz/Research/netcdf/lib -L/Users/djlorenz/lib -lnetcdff -lnetcdf  -llapack -lblas -lmylib
program lwn
  ...
  call get_CCSM(minlon,maxlon,minlat,maxlat,-7,3,'FLNS')
  ...
  call get_CCSM(minlon,maxlon,minlat,maxlat,decade1,decade2,'FLNS')
