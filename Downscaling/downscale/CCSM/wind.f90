...
!gfortran -O3 -o wind wind.f90 read_CCSM.o -I/Users/djlorenz/Research/netcdf/include -I/Users/djlorenz/lib -L/Users/djlorenz/Research/netcdf/lib -L/Users/djlorenz/lib -lnetcdff -lnetcdf  -llapack -lblas -lmylib
program wind
  ...
  call get_CCSM(minlon,maxlon,minlat,maxlat,-7,3,'WIND')
  ...
  call get_CCSM(minlon,maxlon,minlat,maxlat,decade1,decade2,'WIND')

  call ctlwrite('wind.ctl','wind',lons=lonsc,lats=latsc, &
       nlev=ndecade,minlev=0.01*decade1,dlev=0.01,nens=4)
  open(1,file='wind.dat',access='direct',form='unformatted',recl=4*nlonc*nlatc)
