...
!gfortran -O3 -o swu swu.f90 read_CCSM.o -I/Users/djlorenz/Research/netcdf/include -I/Users/djlorenz/lib -L/Users/djlorenz/Research/netcdf/lib -L/Users/djlorenz/lib -lnetcdff -lnetcdf  -llapack -lblas -lmylib
program swu
  ...
  ! get grid
  call get_CCSM(missing,missing,missing,missing,0,0,'FSR')
  if(nlatT /= nlatc) then
  ...
  call get_CCSM(minlon,maxlon,minlat,maxlat,-7,3,'FSR')
  ...
  call get_CCSM(minlon,maxlon,minlat,maxlat,decade1,decade2,'FSR')
