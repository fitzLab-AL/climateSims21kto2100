...
!gfortran -O3 -o prcpL prcpL.f90 read_CCSM.o -I/Users/djlorenz/Research/netcdf/include -I/Users/djlorenz/lib -L/Users/djlorenz/Research/netcdf/lib -L/Users/djlorenz/lib -lnetcdff -lnetcdf  -llapack -lblas -lmylib
program prcp
  ...
  call get_CCSM(minlon,maxlon,minlat,maxlat,decade_ref1,decade_ref2,'PRECT')
...
!  print*, count(xave(:,:,1)==0.0); stop
  ...
  call get_CCSM(minlon,maxlon,minlat,maxlat,decade1,decade2,'PRECT')
