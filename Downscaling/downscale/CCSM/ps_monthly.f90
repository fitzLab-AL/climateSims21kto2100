!seasonal surface pressure => monthly surface pressure
!gfortran -O3 -o ps_monthly ps_monthly.f90 read_CCSM.o hybrj.o seasonal_monthly.o -I/Users/djlorenz/Research/netcdf/include -I/Users/djlorenz/lib -L/Users/djlorenz/Research/netcdf/lib -L/Users/djlorenz/lib -lnetcdff -lnetcdf  -llapack -lblas -lmylib
program ps
  ...
  open(1,file='ps.dat',access='stream',form='unformatted')
  read(1) xsea
  close(1)
...
!              call sea1month(xsea(ilon,ilat,idecade,:),xmon(ilon,ilat,idecade,:))
  ...
  call ctlwrite('ps_monthly.ctl','ps',lons=lonsc,lats=latsc, &
       nlev=ndecade,minlev=0.01*decade1,dlev=0.01,nens=12)
  open(1,file='ps_monthly.dat',access='stream',form='unformatted')
  write(1) xmon
  close(1)
