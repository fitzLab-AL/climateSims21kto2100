!seasonal net longwave => monthly net longwave
!gfortran -O3 -o lwn_monthly lwn_monthly.f90 read_ECBilt.o hybrj.o seasonal_monthly.o -I/Users/djlorenz/Research/netcdf/include -I/Users/djlorenz/lib -L/Users/djlorenz/Research/netcdf/lib -L/Users/djlorenz/lib -lnetcdff -lnetcdf  -llapack -lblas -lmylib
program lwn
  ...
  open(1,file='lwn.dat',access='stream',form='unformatted')
  read(1) xsea
  close(1)
...
!              call sm_factor(xbox(ilon,ilat,:),xsea(ilon,ilat,idecade,:),xmon(ilon,ilat,idecade,:),2)
  ...
  call ctlwrite('lwn_monthly.ctl','lwn',lons=lonsc,lats=latsc, &
       nlev=ndecade,minlev=0.01*decade1,dlev=0.01,nens=12)
  open(1,file='lwn_monthly.dat',access='stream',form='unformatted')
  write(1) xmon
  close(1)
