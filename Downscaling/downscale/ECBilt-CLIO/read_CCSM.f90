...
contains
  ...
  subroutine get_ECBilt(lon11,lon22,lat1,lat2,time1,time2,vars)
    ...
    call handle_err(nf90_open('/Users/djlorenz/Research/jack/ECBilt/special/'// &
    ...
    call handle_err(nf90_open('/Users/djlorenz/Research/jack/ECBilt/special/'// &
         'b30.00_4kaDVTd.clm2.ncrcat.djf.FSR.nc',nf90_nowrite,ncid(4)))
    ...
    if(lon1==missing .or. lon2==missing) then
       ...
       if(dmin==0 .or. dmax==0) then
          print*, 'ERROR: read_ECBilt: longitude range outside dataset'
          stop
       endif
    endif
    if(dmax>=dmin) then
    ...
    if(lat1==missing .or. lat2==missing) then
       ...
       enddo
       if(dmin==0 .or. dmax==0) then
          print*, 'ERROR: read_ECBilt: latitude range outside dataset'
          stop
       endif
    endif
    if(dmax<dmin) then
    ...
    ntc = time2 - time1 + 1
    if(ntc < 1) then
       print*, 'ERROR: read_ECBilt: time2 < time1'
       stop
    endif
    t_start = time1 + 2200 + 1
    if(t_start < 1 .or. t_start > nt0) then
       print*, 'ERROR: read_ECBilt: time1 out of range'
       stop
    endif
    t_end = time2 + 2200 + 1
    if(t_end < 1 .or. t_end > nt0) then
       print*, 'ERROR: read_ECBilt: time2 out of range'
       stop
    endif
    ...
    do ivar=1,nvar
       if(filen(ivar)==2 .or. filen(ivar)==4) then
    ...
    call handle_err(nf90_open('/Users/djlorenz/Research/jack/ECBilt/special/'// &
         'b30.00_4kaDVTd.clm2.ncrcat.mam.FSR.nc',nf90_nowrite,ncid(4)))
    do it=t_start,t_end
       do ivar=1,nvar
          start = [lon_start,lat_start,it]
          ncount = [nlonc,nlatc,1]
    ...
    call handle_err(nf90_open('/Users/djlorenz/Research/jack/ECBilt/special/'// &
         'b30.00_4kaDVTd.clm2.ncrcat.jja.FSR.nc',nf90_nowrite,ncid(4)))
    do it=t_start,t_end
       do ivar=1,nvar
          start = [lon_start,lat_start,it]
          ncount = [nlonc,nlatc,1]
    ...
    call handle_err(nf90_open('/Users/djlorenz/Research/jack/ECBilt/special/'// &
         'b30.00_4kaDVTd.clm2.ncrcat.son.FSR.nc',nf90_nowrite,ncid(4)))
    do it=t_start,t_end
       do ivar=1,nvar
          start = [lon_start,lat_start,it]
          ncount = [nlonc,nlatc,1]
