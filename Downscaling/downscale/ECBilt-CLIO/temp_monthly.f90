...
!gfortran -O3 -o temp_monthly temp_monthly.f90 read_ECBilt.o hybrj.o seasonal_monthly.o -I/Users/djlorenz/Research/netcdf/include -I/Users/djlorenz/lib -L/Users/djlorenz/Research/netcdf/lib -L/Users/djlorenz/lib -lnetcdff -lnetcdf -llapack -lblas -lmylib
program temp
  ...
  x = sum(0.5*(x1(:,:,1,:,:)+x1(:,:,2,:,:)),dim=4)/nyear
  ...
  call ctlwrite('temp_monthly.ctl','temp',lons=lonsc,lats=latsc, &
