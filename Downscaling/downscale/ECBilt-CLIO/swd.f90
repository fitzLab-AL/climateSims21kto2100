...
!gfortran -O3 -o swd swd.f90 read_ECBilt.o -I/Users/djlorenz/Research/netcdf/include -I/Users/djlorenz/lib -L/Users/djlorenz/Research/netcdf/lib -L/Users/djlorenz/lib -lnetcdff -lnetcdf  -llapack -lblas -lmylib
program swd
  ...
  call get_ECBilt(minlon,maxlon,minlat,maxlat,-11,-1,'swd')
  ...
  call get_ECBilt(minlon,maxlon,minlat,maxlat,decade1,decade2,'swd')
