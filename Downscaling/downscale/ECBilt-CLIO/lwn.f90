!downscale net longwave radiation at surface
!gfortran -O3 -o lwn lwn.f90 read_ECBilt.o -I/Users/djlorenz/Research/netcdf/include -I/Users/djlorenz/lib -L/Users/djlorenz/Research/netcdf/lib -L/Users/djlorenz/lib -lnetcdff -lnetcdf  -llapack -lblas -lmylib
program lwn
  ...
  call get_ECBilt(minlon,maxlon,minlat,maxlat,-11,-1,'lwn')
  ...
  call get_ECBilt(minlon,maxlon,minlat,maxlat,decade1,decade2,'lwn')

  call ctlwrite('lwn.ctl','lwn',lons=lonsc,lats=latsc, &
       nlev=ndecade,minlev=0.01*decade1,dlev=0.01,nens=4)
  open(1,file='lwn.dat',access='direct',form='unformatted',recl=4*nlonc*nlatc)
