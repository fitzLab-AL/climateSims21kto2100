!downscale RELATIVE upward shortwave radiation at surface
!gfortran -O3 -o swu swu.f90 read_ECBilt.o -I/Users/djlorenz/Research/netcdf/include -I/Users/djlorenz/lib -L/Users/djlorenz/Research/netcdf/lib -L/Users/djlorenz/lib -lnetcdff -lnetcdf  -llapack -lblas -lmylib
program swu
  ...
  ! get grid
  call get_ECBilt(missing,missing,missing,missing,-1,-1,'swd')
  if(nlatT /= nlatc) then
  ...
  open(1,file='../../berger1978/insol32.dat',access='stream',form='unformatted')
  read(1) insol
  close(1)

  call get_ECBilt(minlon,maxlon,minlat,maxlat,-11,-1,'swd alb')
  ...
  call get_ECBilt(minlon,maxlon,minlat,maxlat,decade1,decade2,'swd alb')
  ...
  call ctlwrite('swu.ctl','swu',lons=lonsc,lats=latsc, &
       nlev=ndecade,minlev=0.01*decade1,dlev=0.01,nens=4)
  open(1,file='swu.dat',access='direct',form='unformatted',recl=4*nlonc*nlatc)
