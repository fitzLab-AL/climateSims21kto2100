...
!gfortran -O3 -o prcp_final prcp_final.f90 read_ECBilt.o write_final.o -I/Users/djlorenz/Research/netcdf/include -I/Users/djlorenz/lib -L/Users/djlorenz/Research/netcdf/lib -L/Users/djlorenz/lib -lnetcdff -lnetcdf  -llapack -lblas -lmylib
program prcp0
  ...
  call ncopen(1,'/Users/djlorenz/Research/jack/final/ECBilt/prcp.nc','prcp ', &
       vunits='mm',vnames='mean monthly precipitation accumulation;', &
       lons=lons,lats=lats,title='Downscaled ECBilt runs. Monthly means by decade.', &
