...
ncdfToFutDecade = function(ncdf, outDirectory, model, interval, years, brack){
    ## Testing Lines: for development
    # ncdf = netCDF
    # outDirectory = outDirList45[[1]]
    # model = scenerioList45[1]
    # interval = 12
    # years = c(5,10,15,25,35,45,55,65,75,85,95)
    # brack <- 5         ##in years, multiplied by interval within function, to account that the intervals within the NetCDF are in months
    ...
    for(vn in 1:ncdf$nvars){
        ...
        for(i in 1:length(januarySeq)){
            ...
            startBrack <- (brack-1)*interval
            endBrack <- brack*interval
            
            startIndex <- januarySeq[i]-startBrack
            if(startIndex<0){
                startIndex <- 1
            }
            startDay = days[startIndex]
            endDay = days[(januarySeq[i]+interval-1)+endBrack]
            ...
            if(length(BP)>0){
                ...
                for(day in 1:length(BP)){
                    #day=1
                    #print(paste("yr value: ", as.character(yr), sep=""))
                    r=BP[day]
                    ...
                    quartMinList[day] = quartMin
                    quartMaxList[day] = quartMax
                    
                    ##by month
                    monthMin = calc(x=stack(rastList), fun=min)
                    monthMax = calc(x=stack(rastList), fun=max)
                    monthMinList[day] = monthMin
                    monthMaxList[day] = monthMax
...
createFutureETR = function(ncdf, outDirectory, model, interval, years, brack){
    ## Testing Lines: for development
    # ncdf = netCDF
...
createFutureWDEI = function(etncdf, precipncdf, outDirectory, model, interval, years, brack){
    ## Testing Lines: for development
...
for(ind in 1:length(netCDFlist45)){
    ...
    ncdfToFutDecade(netCDF, outDirList45[ind], scenerioList45[ind], interval=12, years=c(5,15,25,35,45,55,65,75,85), brack=10)
    nc_close(netCDF)
}
...
for(ind in 1:length(netCDFlist85)){
    ...
    ncdfToFutDecade(netCDF, outDirList85[ind], scenerioList85[ind], interval=12, years=c(5,15,25,35,45,55,65,75,85), brack=10)
    nc_close(netCDF)
}
...
for(ind in 1:length(etCDFlist45)){
    ...
    createFutureETR(netCDF, outETDir45[ind], etScenList45[ind], interval=12, years=c(5,15,25,35,45,55,65,75,85), brack=10)
    nc_close(netCDF)
}
...
for(ind in 1:length(etCDFlist85)){
    ...
    createFutureETR(netCDF, outETDir85[ind], etScenList85[ind], interval=12, years=c(5,15,25,35,45,55,65,75,85), brack=10)
    nc_close(netCDF)
}

## Runs createWDEI for future climates RCP4.5
##ACCESS1-3_45
createFutureWDEI(netCDFlist45[1], netCDFlist45[3], outDirList45[1], scenerioList45[1], interval=12, years=c(5,15,25,35,45,55,65,75,85,95), brack=10)
##CanESM2_45
createFutureWDEI(netCDFlist45[5], netCDFlist45[7], outDirList45[5], scenerioList45[5], interval=12, years=c(5,15,25,35,45,55,65,75,85,95), brack=10)
##CESM1-CAM5_45
createFutureWDEI(netCDFlist45[9], netCDFlist45[11], outDirList45[9], scenerioList45[9], interval=12, years=c(5,15,25,35,45,55,65,75,85,95), brack=10)
##CNRM-CM5_45
createFutureWDEI(netCDFlist45[13], netCDFlist45[15], outDirList45[13], scenerioList45[13], interval=12, years=c(5,15,25,35,45,55,65,75,85,95), brack=10)
##CSIRO-MK3-6-0_45
createFutureWDEI(netCDFlist45[17], netCDFlist45[19], outDirList45[17], scenerioList45[17], interval=12, years=c(5,15,25,35,45,55,65,75,85,95), brack=10)
##GFDL-cm3_45
createFutureWDEI(netCDFlist45[21], netCDFlist45[23], outDirList45[21], scenerioList45[21], interval=12, years=c(5,15,25,35,45,55,65,75,85,95), brack=10)
##GISS-E2-R_45
createFutureWDEI(netCDFlist45[25], netCDFlist45[27], outDirList45[25], scenerioList45[25], interval=12, years=c(5,15,25,35,45,55,65,75,85,95), brack=10)
##HadGEM2-ES_45
createFutureWDEI(netCDFlist45[29], netCDFlist45[31], outDirList45[29], scenerioList45[29], interval=12, years=c(5,15,25,35,45,55,65,75,85,95), brack=10)
##inmcm4_45
createFutureWDEI(netCDFlist45[33], netCDFlist45[35], outDirList45[33], scenerioList45[33], interval=12, years=c(5,15,25,35,45,55,65,75,85,95), brack=10)
##IPSL-CM5A-MR_45
createFutureWDEI(netCDFlist45[37], netCDFlist45[39], outDirList45[37], scenerioList45[37], interval=12, years=c(5,15,25,35,45,55,65,75,85,95), brack=10)
##MIROC5_45
createFutureWDEI(netCDFlist45[41], netCDFlist45[43], outDirList45[41], scenerioList45[41], interval=12, years=c(5,15,25,35,45,55,65,75,85,95), brack=10)
##MRI-CGCM3_45
createFutureWDEI(netCDFlist45[45], netCDFlist45[47], outDirList45[45], scenerioList45[45], interval=12, years=c(5,15,25,35,45,55,65,75,85,95), brack=10)

## Runs createWDEI for future climates RCP8.5
##ACCESS1-3_85
createFutureWDEI(netCDFlist85[1], netCDFlist85[3], outDirList85[1], scenerioList85[1], interval=12, years=c(5,15,25,35,45,55,65,75,85,95), brack=10)
##CanESM2_85
createFutureWDEI(netCDFlist85[5], netCDFlist85[7], outDirList85[5], scenerioList85[5], interval=12, years=c(5,15,25,35,45,55,65,75,85,95), brack=10)
##CESM1-CAM5_85
createFutureWDEI(netCDFlist85[9], netCDFlist85[11], outDirList85[9], scenerioList85[9], interval=12, years=c(5,15,25,35,45,55,65,75,85,95), brack=10)
##CNRM-CM5_85
createFutureWDEI(netCDFlist85[13], netCDFlist85[15], outDirList85[13], scenerioList85[13], interval=12, years=c(5,15,25,35,45,55,65,75,85,95), brack=10)
##CSIRO-MK3-6-0_85
createFutureWDEI(netCDFlist85[17], netCDFlist85[19], outDirList85[17], scenerioList85[17], interval=12, years=c(5,15,25,35,45,55,65,75,85,95), brack=10)
##GFDL-cm3_85
createFutureWDEI(netCDFlist85[21], netCDFlist85[23], outDirList85[21], scenerioList85[21], interval=12, years=c(5,15,25,35,45,55,65,75,85,95), brack=10)
##GISS-E2-R_85
createFutureWDEI(netCDFlist85[25], netCDFlist85[27], outDirList85[25], scenerioList85[25], interval=12, years=c(5,15,25,35,45,55,65,75,85,95), brack=10)
##HadGEM2-ES_85
createFutureWDEI(netCDFlist85[29], netCDFlist85[31], outDirList85[29], scenerioList85[29], interval=12, years=c(5,15,25,35,45,55,65,75,85,95), brack=10)
##inmcm4_85
createFutureWDEI(netCDFlist85[33], netCDFlist85[35], outDirList85[33], scenerioList85[33], interval=12, years=c(5,15,25,35,45,55,65,75,85,95), brack=10)
##IPSL-CM5A-MR_85
createFutureWDEI(netCDFlist85[37], netCDFlist85[39], outDirList85[37], scenerioList85[37], interval=12, years=c(5,15,25,35,45,55,65,75,85,95), brack=10)
##MIROC5_85
createFutureWDEI(netCDFlist85[41], netCDFlist85[43], outDirList85[41], scenerioList85[41], interval=12, years=c(5,15,25,35,45,55,65,75,85,95), brack=10)
##MRI-CGCM3_85
createFutureWDEI(netCDFlist85[45], netCDFlist85[47], outDirList85[45], scenerioList85[45], interval=12, years=c(5,15,25,35,45,55,65,75,85,95), brack=10)
...
period <- seq(2010, 2090, by=10)

yStart <- c(1461, 5113, 8766, 12418, 16071, 19723, 23376, 27028, 30681)
yEnd <- c(1795, 5448, 9100, 12753, 16405, 20058, 23710, 27363, 31015)
